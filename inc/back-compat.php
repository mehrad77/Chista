 ...
 *
 * Prevents Chronus from running on WordPress versions prior to 4.4,
 ...
 * Chronus on WordPress versions prior to 4.4.
 *
 * @global string $wp_version WordPress version.
 */
function chronus_upgrade_notice() {
	$message = sprintf( esc_html__( '%1$s requires at least WordPress version %2$s. You are running version %3$s. Please upgrade and try again.', 'chronus' ), 'Chronus', '4.4', $GLOBALS['wp_version'] );
...
function chronus_customize() {
	wp_die( sprintf( esc_html__( '%1$s requires at least WordPress version %2$s. You are running version %3$s. Please upgrade and try again.', 'chronus' ), 'Chronus', '4.4', $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function chronus_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( esc_html__( '%1$s requires at least WordPress version %2$s. You are running version %3$s. Please upgrade and try again.', 'chronus' ), 'Chronus', '4.4', $GLOBALS['wp_version'] ) );
	}
}
