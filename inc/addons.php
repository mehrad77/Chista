 ...
 */
function chista_theme_addons_setup() {

	// Add theme support for chista Pro plugin.
	add_theme_support( 'chista-pro' );
	...
	add_theme_support( 'infinite-scroll', array(
		...
		'render'         => 'chista_infinite_scroll_render',
	) );
...
add_action( 'after_setup_theme', 'chista_theme_addons_setup' );


/**
 * Load custom stylesheets for theme addons
 */
function chista_theme_addons_scripts() {
...
add_action( 'wp_enqueue_scripts', 'chista_theme_addons_scripts' );


/**
 * Custom render function for Infinite Scroll.
 */
function chista_infinite_scroll_render() {
	while ( have_posts() ) {
		the_post();
 ...
 */
function chista_wrapper_start() {
	echo '<section id="primary" class="content-area">';
	echo '<main id="main" class="site-main" role="main">';
}
remove_action( 'woocommerce_before_main_content', 'woocommerce_output_content_wrapper', 10 );
add_action( 'woocommerce_before_main_content', 'chista_wrapper_start', 10 );


/**
 * Set wrapper end for wooCommerce
 */
function chista_wrapper_end() {
	echo '</main><!-- #main -->';
	echo '</section><!-- #primary -->';
}
remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10 );
add_action( 'woocommerce_after_main_content', 'chista_wrapper_end', 10 );
