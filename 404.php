            ...
            <div class="entry-content clearfix">
                ...
                <div class="card">
                    ...
                    <div class="card-content white-text">
                        ...
                        <div class="content">
                        <?php esc_html_e(' حتی چیزهایی که ما دوست داریم، گاهی اوقات می‌شکنند؛ دیگه یه لینک که این حرف‌ها رو نداره :)','chista'); ?>
                            <br/>
                            <?php esc_html_e('پیوند درخواست‌شده پیدا نشد و این تمام چیزی است که من می‌دانم و از صبر و شکیبایی شما متشکرم.','chista'); ?>
                            <br/>
                            <br/>
                            <?php esc_html_e('با‌این حال شما می‌توانید:','chista'); ?>
                            <ul>
